                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <canvas id="tanggal" height="100"></canvas>
                                <?php
                                foreach ($analisis_tanggal as $key => $value) {
                                    $bpjs[] = $value->bpjs;
                                    $total_bpjs_tanggal[] = $value->total_bpjs_tanggal;
                                }
                                ?>
                                <script>
                                    var ctx = document.getElementById('tanggal');
                                    var landak = new Chart(ctx, {
                                        type: 'bar',
                                        data: {
                                            labels: <?= json_encode($bpjs) ?>,
                                            datasets: [{
                                                label: 'Grafik Analisis BPJS dan Non BPJS',
                                                data: <?= json_encode($total_bpjs_tanggal) ?>,
                                                backgroundColor: [
