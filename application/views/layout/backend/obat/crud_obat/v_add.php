<div class="col-md-6 grid-margin stretch-card">
	<div class="card">
		<div class="card-body">
			...
			<form class="forms-sample" action="<?= base_url('obat/add') ?>" method="POST">
				<div class="form-group row">
					<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Obat</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" name="nama_obat" id="exampleInputUsername2" placeholder="Nama Obat" value="<?= set_value('nama_obat') ?>" required>
					</div>
				</div>
				<div class="form-group row">
					<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Jenis Obat</label>
					<div class="col-sm-9">
						<select class="form-control" name="jenis_obat" value="<?= set_value('jenis_obat') ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="number" name="stock" class="form-control" id="exampleInputMobile" placeholder="Mobile number" value="<?= set_value('stock') ?>" required>
					</div>
				</div>
